import { reactive, getCurrentInstance, defineAsyncComponent, version, toRef, isRef, inject, nextTick, shallowRef, computed, isReadonly, h, defineComponent, Suspense, Transition, provide, useSSRContext, onErrorCaptured, onServerPrefetch, unref, createApp } from "vue";
...
import { hasProtocol, parseURL, joinURL, isEqual, withLeadingSlash, encodeParam, encodePath } from "ufo";
import "destr";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_...slug_-109a1d95.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-3bd0a382.js").then((m) => m.default || m)
  }
];
...
const ipxRuntime$7wJm2GcfkJ = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$7wJm2GcfkJ, defaults: {} }
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-28208494.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-debdb600.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
