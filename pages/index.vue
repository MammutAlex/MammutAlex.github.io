<template>
  <div class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover">
    <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
      ...
      <!--Main Col-->
      <div id="profile"
           class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-100 mx-6 lg:mx-0 dark:bg-gray-900">


        <div class="p-4 md:p-12 text-center lg:text-left dark:text-gray-300">
          <!-- Image for mobile view-->
          <div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center profile"></div>

          <h1 class="text-3xl font-bold pt-8 lg:pt-0">Alex Kovalchuk</h1>
          ...
          <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
            <a class="link" href="https://www.facebook.com/alex.kovalchuk42" data-tippy-content="@alex.kovalchuk42">
            ...
            <a class="link" href="https://twitter.com/AlexMammut" data-tippy-content="@AlexMammut">
              <svg class="h-6 fill-current text-gray-600 hover:text-teal-700" role="img" viewBox="0 0 24 24"
            ...
            <a class="link" href="https://github.com/MammutAlex" data-tippy-content="@MammutAlex">
              <svg class="h-6 fill-current text-gray-600 hover:text-teal-700" role="img" viewBox="0 0 24 24"
            ...
            <a class="link" href="https://www.instagram.com/mammutcave" data-tippy-content="@mammutcave">
              <svg class="h-6 fill-current text-gray-600 hover:text-teal-700" role="img" viewBox="0 0 24 24"
      ...
      <div class="w-full lg:w-2/5">
        <img src="../static/images/photo.jpeg" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
      </div>
